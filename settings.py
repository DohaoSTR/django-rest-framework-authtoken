...
AUTH_TOKEN_VALIDITY = getattr(settings, 'AUTH_TOKEN_VALIDITY', timedelta(hours=12))
AUTH_TOKEN_MAX_COUNT_ON_USER = getattr(settings, 'AUTH_TOKEN_MAX_COUNT_ON_USER', 1)
